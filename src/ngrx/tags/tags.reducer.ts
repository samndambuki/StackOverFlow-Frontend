...
import { loadTags, loadTagsSuccess, loadTagsFailure, addTag, addTagSuccess, addTagFailure } from './tags.actions';
...
export interface TagsState {
  ...
  export const tagsReducer = createReducer(
    ...
    on(loadTagsSuccess, (state, { tags }) => ({ ...state, tags, loading: false, error: null })),
    on(loadTagsFailure, (state, { error }) => ({ ...state, loading: false, error })),
